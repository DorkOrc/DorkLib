...
execute unless data storage dorklib:main functions."do:list/index".list[0] run return run function dorklib:exception {args:{message:[{storage:"dorklib:main",nbt:'functions."do:list/index".value_repr'}," is not in list"]}}

scoreboard players set #parially_in_list dorklib.var 0
function dorklib:impl/list/index/check_if_value_partially_in_list with storage dorklib:main functions."do:list/index"
execute if score #parially_in_list dorklib.var matches 0 run return run function dorklib:exception {args:{message:[{storage:"dorklib:main",nbt:'functions."do:list/index".value_repr'}," is not in list"]}}

# loop through list to find index
scoreboard players set #index dorklib.var -1
return run function dorklib:impl/list/index/loop
