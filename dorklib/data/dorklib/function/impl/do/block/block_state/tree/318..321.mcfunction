...
execute if block ~ ~ ~ minecraft:dead_fire_coral run return run function dorklib:impl/do/block/block_state/tree/dead_fire_coral
...
execute if block ~ ~ ~ minecraft:dead_fire_coral_fan run return run function dorklib:impl/do/block/block_state/tree/dead_fire_coral_fan
