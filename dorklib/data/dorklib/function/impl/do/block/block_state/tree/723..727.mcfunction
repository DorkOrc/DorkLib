...
execute if block ~ ~ ~ minecraft:pink_wall_banner run return run function dorklib:impl/do/block/block_state/tree/pink_wall_banner
execute if block ~ ~ ~ minecraft:pink_wool run return run data modify storage do:io output set value {Name:"minecraft:pink_wool"}
execute if block ~ ~ ~ minecraft:piston run return run function dorklib:impl/do/block/block_state/tree/piston
