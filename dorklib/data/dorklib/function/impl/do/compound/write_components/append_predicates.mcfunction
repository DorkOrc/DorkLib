...
execute if data storage dorklib:main functions."do:compound/write_components".items run function dorklib:impl/do/compound/write_components/loop_predicates
