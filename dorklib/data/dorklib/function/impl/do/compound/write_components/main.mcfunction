...
execute if data storage dorklib:main functions."do:compound/write_components".items run function dorklib:impl/do/compound/write_components/loop

# get text components from args.predicates
execute if data storage dorklib:main functions."do:compound/write_components".args.predicates run function dorklib:impl/do/compound/write_components/append_predicates

# get text components from args.components
execute if data storage dorklib:main functions."do:compound/write_components".args.components run function dorklib:impl/do/compound/write_components/append_components
