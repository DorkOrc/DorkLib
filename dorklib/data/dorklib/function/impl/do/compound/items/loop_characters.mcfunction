...
execute if score #string_key dorklib.var matches 1 if data storage dorklib:main functions."do:compound/items"{c:"\\"} run return run function dorklib:impl/do/compound/items/skip_character
