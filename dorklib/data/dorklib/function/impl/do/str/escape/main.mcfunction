...
execute if score #quote_type dorklib.var matches 1 if data storage dorklib:main functions."do:str/escape"{quote_type:"'"} run function dorklib:impl/do/str/escape/force_double_quote with storage dorklib:main functions."do:str/escape"
execute if score #quote_type dorklib.var matches 2 if data storage dorklib:main functions."do:str/escape"{quote_type:'"'} run function dorklib:impl/do/str/escape/force_single_quote with storage dorklib:main functions."do:str/escape"
