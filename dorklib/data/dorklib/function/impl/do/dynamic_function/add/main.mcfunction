...
execute unless score #commands_per_entry dorklib.var matches 1..4 run return run function dorklib:exception {args:{message:"commands_per_entry must be at least 1 and at most 4"}}
...
execute if score #already_registered dorklib.var matches 1 run return run function dorklib:exception {args:{message:"A dynamic function with that ID is already registered"}}
...
execute unless score #tree_group dorklib.var matches 0.. run return run function dorklib:exception {args:{message:"Failed to register dynamic function: Dynamic function registry limit (63) has been reached"}}
