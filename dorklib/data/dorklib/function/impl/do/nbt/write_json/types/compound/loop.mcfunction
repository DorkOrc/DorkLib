...
data modify storage do:io input set value ['"',{storage:"dorklib:main",nbt:'functions."do:nbt/write_json".stack[-1].escaped_key'},'":',{storage:"dorklib:main",nbt:'functions."do:nbt/write_json".returned',interpret:true}]
