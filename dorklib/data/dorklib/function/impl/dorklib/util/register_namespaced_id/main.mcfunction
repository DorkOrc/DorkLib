...
execute if data storage dorklib:main functions."dorklib:util/register_namespaced_id"{check_hardcoded_namespace:"dorklib."} run return run function dorklib:impl/dorklib/util/register_namespaced_id/register_dorklib_derivative_namespace with storage dorklib:main functions."dorklib:util/register_namespaced_id"
...
execute if data storage dorklib:main functions."dorklib:util/register_namespaced_id"{check_hardcoded_namespace:"do:"} run return run function dorklib:impl/dorklib/util/register_namespaced_id/register_dorklib_derivative_namespace with storage dorklib:main functions."dorklib:util/register_namespaced_id"
execute if data storage dorklib:main functions."dorklib:util/register_namespaced_id"{check_hardcoded_namespace:"do."} run return run function dorklib:impl/dorklib/util/register_namespaced_id/register_dorklib_derivative_namespace with storage dorklib:main functions."dorklib:util/register_namespaced_id"
