...
execute as @e[tag=dorklib.local.functions.do+summon++passenger.passenger,distance=..0.001,limit=1] run function dorklib:impl/summon/passenger/as_passenger with storage dorklib:main functions."do:summon/passenger"
