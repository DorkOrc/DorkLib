execute if block ~ ~ ~ minecraft:mangrove_fence_gate run return run function dorklib:impl/block/block_state/tree/mangrove_fence_gate
execute if block ~ ~ ~ minecraft:mangrove_hanging_sign run return run function dorklib:impl/block/block_state/tree/mangrove_hanging_sign
