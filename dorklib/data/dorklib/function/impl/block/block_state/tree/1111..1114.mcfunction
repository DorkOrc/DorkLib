execute if block ~ ~ ~ minecraft:waxed_weathered_lightning_rod run return run function dorklib:impl/block/block_state/tree/waxed_weathered_lightning_rod
...
execute if block ~ ~ ~ minecraft:weathered_copper_bars run return run function dorklib:impl/block/block_state/tree/weathered_copper_bars
