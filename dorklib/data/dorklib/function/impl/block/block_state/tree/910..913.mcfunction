...
execute if block ~ ~ ~ minecraft:smooth_quartz_slab run return run function dorklib:impl/block/block_state/tree/smooth_quartz_slab
execute if block ~ ~ ~ minecraft:smooth_quartz_stairs run return run function dorklib:impl/block/block_state/tree/smooth_quartz_stairs
