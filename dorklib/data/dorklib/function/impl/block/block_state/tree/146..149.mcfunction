execute if block ~ ~ ~ minecraft:bubble_coral_wall_fan run return run function dorklib:impl/block/block_state/tree/bubble_coral_wall_fan
...
execute if block ~ ~ ~ minecraft:cactus run return run function dorklib:impl/block/block_state/tree/cactus
