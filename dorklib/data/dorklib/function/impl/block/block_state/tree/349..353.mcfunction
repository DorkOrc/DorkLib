execute if block ~ ~ ~ minecraft:detector_rail run return run function dorklib:impl/block/block_state/tree/detector_rail
...
execute if block ~ ~ ~ minecraft:diorite_slab run return run function dorklib:impl/block/block_state/tree/diorite_slab
