...
execute if data storage do:io input[0] run return run function dorklib:impl/nbt/type/get_list_or_array_type
...
function dorklib:impl/nbt/type/check_decimal with storage do:io {}
execute if data storage do:io output run return 1
function dorklib:impl/nbt/type/check_whole_number with storage do:io {}
execute if data storage do:io output run return 1
