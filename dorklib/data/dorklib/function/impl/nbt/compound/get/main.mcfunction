...
data modify storage dorklib:main functions."do:nbt/compound/get".compound set from storage do:io input

# make a copy of the default value
data modify storage dorklib:main functions."do:nbt/compound/get".default set from storage do:io args.default
...
data modify storage dorklib:main functions."do:nbt/compound/get".key set from storage do:io output

# get value
data remove storage do:io output
function dorklib:impl/nbt/compound/get/get_value with storage dorklib:main functions."do:nbt/compound/get"

# fail if no matching key was found and no default value was provided
execute unless data storage do:io output unless data storage dorklib:main functions."do:nbt/compound/get".default run return run function dorklib:exception {args:{message:"No matching key was found and no \"default\" argument was provided"}}

# output default
data modify storage do:io output set from storage dorklib:main functions."do:nbt/compound/get".default
