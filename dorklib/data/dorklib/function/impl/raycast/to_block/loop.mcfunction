...
execute if score #i dorklib.var > #max_iterations dorklib.var run return run function dorklib:impl/raycast/to_block/final_destination/main with storage dorklib:local functions."do:raycast/to_block"
scoreboard players add #i dorklib.var 1

# stop once not in air
execute unless block ~ ~ ~ air run return run function dorklib:impl/raycast/to_block/final_destination/main with storage dorklib:local functions."do:raycast/to_block"
