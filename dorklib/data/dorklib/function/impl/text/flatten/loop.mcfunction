...
data modify storage dorklib:main functions."do:text/flatten".components insert 1 from storage dorklib:main functions."do:text/flatten".element.extra[]

# repeat until all components have been found
execute if data storage dorklib:main functions."do:text/flatten".components[0] run function dorklib:impl/text/flatten/loop
