...
function dorklib:impl/str/join/concatenate_suffix with storage dorklib:main functions."do:str/join"

execute if data storage dorklib:main functions."do:str/join".substrings[0] run function dorklib:impl/str/join/loop
