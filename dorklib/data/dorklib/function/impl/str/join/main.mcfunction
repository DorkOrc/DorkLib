...
execute unless entity @s summon marker if function do:remove_entity run return run function dorklib:impl/text/join/main
...
execute if data storage do:io args.separator unless data storage do:io args{separator:""} run function dorklib:impl/str/join/escape_separator
...
function dorklib:impl/str/join/insert_single_quote with storage do:io

data modify storage dorklib:main functions."do:str/join".temp_list set value [""]
execute in minecraft:overworld run function dorklib:impl/str/join/loop
