...
execute if score #different_character dorklib.var matches 0 if function dorklib:impl/str/split/check_for_separator run function dorklib:impl/str/split/split_here with storage dorklib:main functions."do:str/split"
execute if score #splits dorklib.var >= #max_splits dorklib.var run return 0

execute if score #index dorklib.var < #string_length dorklib.var run function dorklib:impl/str/split/loop
