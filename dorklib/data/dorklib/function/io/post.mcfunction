...
execute if score #success dorklib.var matches 0 unless data storage do:io exception run return run function dorklib:exception {args:{message:"Uncaught exception"}}
