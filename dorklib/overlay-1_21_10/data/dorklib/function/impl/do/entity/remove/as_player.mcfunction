...
execute store result score #immediate_respawn_gamerule dorklib.var run gamerule doImmediateRespawn
...
execute if score #immediate_respawn_gamerule dorklib.var matches 0 run gamerule doImmediateRespawn false
