...
function dorklib:impl/do/compound/items/loop_characters
...
function dorklib:impl/do/compound/items/slice_out_key with storage dorklib:main functions."do:compound/items"

execute if score #string_key dorklib.var matches 0 run function dorklib:impl/do/compound/items/append_item_unquoted_key with storage dorklib:main functions."do:compound/items"
execute if score #string_key dorklib.var matches 1 run function dorklib:impl/do/compound/items/append_item_quoted_key with storage dorklib:main functions."do:compound/items"
scoreboard players remove #remaining_keys dorklib.var 1

execute if score #remaining_keys dorklib.var matches 1.. run function dorklib:impl/do/compound/items/loop_pairs
